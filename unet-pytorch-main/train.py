...
if __name__ == "__main__":
    ...
    #   数据集路径
    #------------------------------#
    VOCdevkit_path  = '/root/autodl-tmp/Dataset/Project-Dataset/Crack-Dataset/VOC/Crack/'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    if True:
        ...
        train_dataset   = UnetDataset(train_lines, input_shape, num_classes, True, VOCdevkit_path, "train", False)
